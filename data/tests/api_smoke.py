"""Prueba de humo de BlendQueue contra el servidor local (http://127.0.0.1:8777).

Uso:
    .venv\\Scripts\\python.exe data/tests/api_smoke.py quick
    ... api_smoke.py multi
    ... api_smoke.py cycles
    ... api_smoke.py real "G:/ruta/al/archivo.blend" [render]
"""
import json
import sys
import time
